...
class GameMonitorTest {
    ...
    @Test
    public void playerHitsGoesBustSendsResultToGameMonitor() throws Exception {
        GameMonitor gameMonitorSpy = spy(GameMonitor.class);
        Game game = new Game(StubDeck.playerHitsAndGoesBustDeck(), gameMonitorSpy);
        game.initialDeal();
    ...
    @Test
    public void playerHitsDoesNotBustThenNoResultSentToGameMonitor() throws Exception {
        GameMonitor gameMonitorSpy = spy(GameMonitor.class);
